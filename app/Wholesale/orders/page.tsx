                                                    ...
                                                    >
                                                        ...
                                                        <div className="h-12 w-12 bg-slate-50 rounded-xl flex-shrink-0 overflow-hidden border border-slate-100 p-1">
                                                            <img
                                                                ...
                                                                alt={normalizedItem.product_name}
                                                        ...
                                                        <div className="min-w-0 flex-1">
                                                            <p className="text-[10px] font-black text-slate-800 truncate uppercase leading-tight">
                                                                {normalizedItem.product_name}
                                                            </p>

                                                            <p className="text-[9px] font-bold text-red-600 uppercase mt-0.5">
                                                                {normalizedItem.quantity} {normalizedItem.unit}
                                                            </p>

                                                            <div className="flex justify-between mt-1">
                                                                <span className="text-[9px] text-slate-400 font-bold">
                                                                    ₹{normalizedItem.price_at_purchase.toLocaleString("en-IN")} / unit
                                                                </span>

                                                                <span className="text-[9px] font-black text-slate-900">
                                                                    ₹{normalizedItem.subtotal.toLocaleString("en-IN")}
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    {ret.status !== "approved" &&
                                        ret.status !== "cancelled" && (
                                            ...
                                            <button
                                                ...
                                                className="mt-4 w-full border border-red-200 text-red-600 hover:bg-red-50 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all"
                                            >
                                                Cancel Return
                                            </button>
